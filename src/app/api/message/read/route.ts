    ...
    try {
        ...
        if (db) {
            ...
            for (const row_message of db) {
                messages.push(
                    { message_id:row_message.message_id, role:'user', message:row_message.user_prompt , created_at: row_message.created_at, file_meta_data: row_message.file_meta_data},
