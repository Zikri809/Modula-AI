  ...
  return (
   <div className="flex flex-col h-screen overflow-hidden bg-black">
      ...
      <div className=" z-2 p-4  h-full  flex flex-col gap-2 items-center justify-center ">
        ...
        <Button onClick={toLoginPage} className="mt-2 text-lg backdrop-blur-lg bg-white/20 hover:bg-white hover:text-black hover:scale-105 transition-transform ease-in-out">Login / Sign Up</Button>
