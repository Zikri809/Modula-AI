                    ...
                    <form className="text-white" onSubmit={(e) => {
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="grid gap-3">
                                ...
                                <Input className="border-neutral-500" value={email}
                            ...
                            <div className="flex flex-col gap-3">
                                <Button type="submit" className="w-full bg-neutral-700 hover:bg-neutral-400"
                                    ...
                                    {signIn_loading || signup_loading ? <Loader2Icon className="animate-spin"/> : <></>}
                                    <LogIn/> Login
                                </Button>
                                <Button onClick={sign_in_google} variant="outline"
